...
console.log(areSmae(address1, address2));
console.log(areSmae(address1, address3));
...
function areSmae(address1, address2) {
...
let post2 = new Post("aa", "bb", "cc");
console.log(post2);

//excercise price range
let priceRanges = [
  { label: "$", tooltip: "inexpennsive", minPerPerson: 0, maxPerPerson: 10 },
  { label: "$$", tooltip: "moderate", minPerPerson: 11, maxPerPerson: 20 },
  { label: "$$$", tooltip: "Expennsive", minPerPerson: 21, maxPerPerson: 50 },
];
let restaurant = {
  priceAverage: 12,
};
...
// finding element
// primitive data
console.log(numbers.indexOf(1)); // fingding index
console.log(numbers.lastIndexOf(1)); // fingding index of the last order

console.log(numbers.includes(1)); // searching is given element exist in array
...
console.log(courses.find((couse) => course.name === "a"));
